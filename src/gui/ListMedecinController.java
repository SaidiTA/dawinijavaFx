...
@FXML
 ...
 //try{
          //Parent parent =FXMLLoader.load(getClass().getResource("ListeForumAdmin.fxml"));
          //Scene scene =new Scene(parent);
          //Stage stage=new Stage();
          //stage.setScene(scene);
        ...
        //  stage.show();
      //}catch(IOException ex){
        //  Logger.getLogger(ListeForumAdminController.class.getName()).log(Level.SEVERE,null,ex);
      //}
